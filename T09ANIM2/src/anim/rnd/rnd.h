...
extern INT MI6_RndShdAddonI[8];
extern FLT MI6_RndShdAddonF[8];
extern VEC MI6_RndShdAddonV[8];
...
extern MATR MI6_RndPrimLoadTransform;
...
extern VEC MI6_RndCamLoc, MI6_RndCamDir, MI6_RndCamAt, MI6_RndCamRight;
