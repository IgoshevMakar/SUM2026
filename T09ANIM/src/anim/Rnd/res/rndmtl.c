...
INT MI6_RndMtlAdd( mi6MATERIAL *Mtl )
{
  if (MI6_RndMaterialsSize >= MI6_MAX_MATERIALS)
    return 0;

  MI6_RndMaterials[MI6_RndMaterialsSize] = *Mtl;
  return MI6_RndMaterialsSize++;
}
...
UINT MI6_RndMtlApply( INT MtlNo )
{
  ...
  if (MtlNo < 0 || MtlNo >= MI6_RndMaterialsSize)
    MtlNo = 0;
